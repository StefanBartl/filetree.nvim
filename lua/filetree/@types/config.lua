...
---                                use `:Filetree symlink`). Symlink vs. hardlink is chosen at prompt
...
---@field enabled      boolean
---@field keymap_next  string?   Next buffer in adjacent editor window (default "<C-n>").
