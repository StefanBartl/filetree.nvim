...
local trash_platform = require("filetree.features.trash.platform")
local undo           = require("filetree.features.trash.undo")
...
function M.delete(path)
  ...
  if _cfg.use_safety then
    local ok_sf, safety = pcall(require, "filetree.features.safety")
